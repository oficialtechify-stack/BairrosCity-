...
export const NEIGHBORHOODS = [
  ...
  'Dois Carneiros',
  'Zumbi do Pacheco',
  'Santo Aleixo (Jaboatão)',
  'Vila Rica (Jaboatão)',
  'Engenho Velho (Jaboatão)',
  'Santana (Jaboatão)',
  'Loreto (Jaboatão)',
  'Bairro Novo (Olinda)',
  'Rio Doce (Olinda)',
...
export const NEIGHBORHOOD_POPULATION: Record<string, number> = {
  ...
  'Casa Forte': 9000,
  'Setúbal': 22000,
  'Dois Carneiros': 19000,
  'Zumbi do Pacheco': 14000,
  'Santo Aleixo (Jaboatão)': 21000,
  'Vila Rica (Jaboatão)': 17000,
  'Engenho Velho (Jaboatão)': 16000,
  'Santana (Jaboatão)': 11000,
  'Loreto (Jaboatão)': 8500,
  'Pau Amarelo (Paulista)': 28000,
  'Janga (Paulista)': 45000,
  'Maranguape I (Paulista)': 32000,
  'Maranguape II (Paulista)': 29000,
  'Arthur Lundgren I': 16000,
  'Arthur Lundgren II': 14000,
  'Paratibe (Paulista)': 25000,
  'Abreu e Lima Centro': 35000,
  'Igarassu Centro': 40000,
  'Cabo de Santo Agostinho Centro': 55000,
  'Ponte dos Carvalhos': 48000,
  'Pontezinha': 19000,
  'Porto de Galinhas': 12000,
  'Nossa Senhora do Ó (Ipojuca)': 26000,
  'Gaibu (Cabo)': 9500,
  'Poço da Panela': 4200,
  'Santana': 3600,
  'Monteiro': 3900,
